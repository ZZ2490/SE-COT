...
def main(args):
    ...
    model = build_model(cfg)
    model.eval()
    cfg.MODEL.WEIGHTS = "all_outs/diverse_weather_f1_dis_p8_newp_200rain/model_best.pth"
    ...
    # 保存检测结果
    output_image = Visualizer(im, MetadataCatalog.get(cfg.DATASETS.TRAIN[0]), scale=1.2).draw_instance_predictions(
