...
class ClipRCNNWithClipBackbone(GeneralizedRCNN):
    ...
    def __init__(self, cfg) -> None:
        ...
        self.conv_out2 = convblock(2 * 1024, 1024, 3, 1, 1)
    ...
    def inference(
        ...
        basef = self.conv_out(basef)
        features['res4'] = self.conv_out2(torch.cat((features['res4'], basef), dim=1))
